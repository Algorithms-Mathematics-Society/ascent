...
export default function LegalPage({ title, version, publishedOn = "14 September 2026", children }: { title: string; version: string; publishedOn?: string; children: ReactNode }) {
  return <><Navbar page="legal" /><main id="top" className="mx-auto max-w-3xl px-4 pb-16 pt-28 sm:px-6">
    <h1 className="text-4xl font-semibold tracking-tight">{title}</h1>
    <p className="mt-3 text-sm text-ascent-muted">Ascent ’26 · Version {version} · Published {publishedOn}</p>
