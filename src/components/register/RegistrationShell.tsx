        ...
        <header className="border-b border-ascent-border bg-ascent-surface">
          <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-10 lg:px-8">
            <div className="max-w-3xl">
              ...
              <h1 className="mt-3 max-w-3xl text-4xl font-semibold tracking-tight text-ascent-ink sm:text-5xl">
                Register for Ascent
              </h1>
              <p className="mt-4 max-w-2xl text-base leading-7 text-ascent-muted sm:text-lg">
